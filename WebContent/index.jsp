...
<div id="modal-settings" class="modal fade">
    ...
    <div class="modal-body">
        <form class="form-horizontal">
            ...
            <!-- <div class="control-group">
                <label class="control-label" for="disable-iframe-preview">Disable IFrame Preview</label>

                <div class="controls">
                    <select class="medium" name="disable-iframe-preview" id="disable-iframe-preview">
                        <option value="true">Yes</option>
                        <option value="false">No</option>
                    </select>
                </div>
            ...
            <div class="control-group" id="postman-proxy-url-container">
                ...
                <div class="controls">
                    <input type="text" name="postman-proxy-url" id="postman-proxy-url" value=""/>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript" src="js/requester.min.js"></script>
<script type="text/javascript" src="js/serverDB.js"></script>
</body>
</html>
